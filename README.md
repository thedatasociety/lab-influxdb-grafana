...
[Binderhub](https://github.com/jupyterhub/binderhub) uses [repo2docker](https://github.com/jupyter/repo2docker) for launching and serving the computational environments.

The list below contains the known [Binderhub](https://github.com/jupyterhub/binderhub) instances.
...
The Jupyter Lab interface will be available at [http://0.0.0.0:8888/lab](http://0.0.0.0:8888/lab)  
